...
function detectUrlHint(url: string): UrlHint {
  ...
  if (u.includes("youtube.com") || u.includes("youtu.be")) {
    return { type: "youtube", icon: "🎬", label: "YouTube 视频", tip: "视频内容无法直接抓取，建议补充一句描述学习目标", canFetch: false };
  }
  if (u.includes("bilibili.com") || u.includes("b23.tv")) {
    return { type: "bilibili", icon: "📺", label: "Bilibili 视频", tip: "视频内容无法直接抓取，建议补充一句描述学习目标", canFetch: false };
  }
  ...
  if (u.includes("medium.com") || u.match(/\w+\.medium\.com/)) {
