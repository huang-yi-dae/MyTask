...
import { fetchWorkspaceDoc, detectWorkspacePlatform } from "./fetchers/workspace";
import { fetchWithFallback, isEmptyShell, extractBasicInfo, detectJsRenderedPlatform } from "./fetchers/fallback";
